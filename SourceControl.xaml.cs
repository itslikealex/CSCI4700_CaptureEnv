...
namespace CSCI4700_CaptureEnv
{
    ...
    public partial class SourceControl : UserControl, ISource
    {
        ...
        private void CheckBox_Checked(object sender, RoutedEventArgs e)
        {
            if ((bool)mUsingChkBx.IsChecked)
            {
                ...
                MainWindow.CaptureManager.getCollectionOfEncoders(ref lxmldoc);
        ...
        {
            MainWindow.SourceItems.Add(this);

            mEncoderControl = MainWindow.CaptureManager.createEncoderControl();

            if (mEncoderControl == null)
                return;

            mSourceControl = MainWindow.CaptureManager.createSourceControl();
            ...
            mStreamControl = MainWindow.CaptureManager.createStreamControl();
            ...
            mSinkControl = MainWindow.CaptureManager.createSinkControl();
    ...
    "</Options>";
        ...
        {
            MainWindow.SourceItems.Remove(this);
        }
    }
}
